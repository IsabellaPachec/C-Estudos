...
void ArvoreBinariadeBusca::buscar(Aluno & aluno, bool &busca){ // o & siginifa que busca por referencia
    ...
    while (noatual!= NULL){//enquanto o no atual for diferente de null faça
